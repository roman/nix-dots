...
(when (configuration-layer/layer-usedp 'org)
  ...
  ;; (defun clocker-on-term-send-raw-string (f &rest args)
  ;;   (let ((res (apply f args)))
  ;;     (when (= (string-to-char (car args)) 13)
  ...
  ;;     :config
  ;;     (progn
  ;;       (evil-leader/set-key "t0" 'clocker-mode)
  ;;       (spacemacs|diminish clocker-mode "◴" " CLCK")
  ;;       (spaceline-install
  ;;         (spaceline-spacemacs-theme '((clocker-status :when active))))
