;;; zoo-filecheck.el --- Zoo checking configuration -*- lexical-binding: t -*-
...
(use-package flyspell
  ...
  :init
  (progn
    (csetq ispell-progrzoo-name "aspell"
...
(use-package flycheck
  ...
  :config (csetq flycheck-global-modes '(not emacs-lisp-mode)))

(provide 'zoo-filecheck)

;;; zoo-filecheck.el ends here
